...
9. No validator scoring in production mode without pinned registry bytes or a pinned procedural source pool.
10. No production registry-authority path without explicit signature verification; procedural mode treats published registries as caches, not authority.
