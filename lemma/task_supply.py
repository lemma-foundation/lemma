...
def make_task(
    *,
    ...
    source_ref=SourceRef(kind=source_stream, name=source_name, path="tasks/registry.json"),
...
def fixed_fixture_tasks(count: int) -> list[LemmaTask]:
    """Fixed local smoke fixtures. These are not generated supply."""
    templates = [
        ("lemma.fixture.true_intro", "Fixture True", "fixture_true_intro", "True", "trivial"),
        ("lemma.fixture.and_intro", "Fixture conjunction", "fixture_and_intro", "True ∧ True", "constructor"),
        (
            "lemma.fixture.nat_zero_add",
            "Fixture Nat zero-add",
            "fixture_nat_zero_add",
            "∀ n : Nat, 0 + n = n",
            "simp",
        ),
        (
            "lemma.fixture.nat_add_zero",
            "Fixture Nat add-zero",
            "fixture_nat_add_zero",
            "∀ n : Nat, n + 0 = n",
            "simp",
        ),
        (
            "lemma.fixture.nat_self_eq",
            "Fixture Nat reflexivity",
            "fixture_nat_self_eq",
            "∀ n : Nat, n = n",
            "rfl",
        ),
    ...
    return [
        make_task(
            ...
            source_name="lemma-fixed-fixtures",
